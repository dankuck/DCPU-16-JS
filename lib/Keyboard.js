...
/*
window.k = new Keyboard(hud);
window.d = dcpu;//new DCPU16.CPU();
d.addDevice(k);

setInterval(function(){
hud.innerHTML = 'Container: ' + k.container + '<br />Buffer: ' + k.buffer.join(';') + "<br />Listeners: " + k.DOMListeners + "<br />Running: " + k.cpu.running;
}, 100);
